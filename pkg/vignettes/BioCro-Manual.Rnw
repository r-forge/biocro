...
<<c4photo-aq-aci, warning=FALSE, fig.height=3.8, tidy=TRUE>>=
pr <- seq(0,2000)
...
<<c4photo-stress-gs, fig.height=4.5, tidy=TRUE, include=FALSE>>=
sws <- seq(0,1,0.01)
...
<<c4photo-stress-vmax, fig.height=4.5, include=FALSE>>=
sws <- seq(0,1,0.01)
