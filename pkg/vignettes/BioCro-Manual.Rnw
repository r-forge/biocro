...
day1 <- 100
dayn <- 270
cmi05.s <- subset(cmi05, doy > 99 & doy < 271)
P <- sum(cmi05.s$precip) ## in mm
iwc <- 0.29
soildepth <- 2
soilP <- soilParms(iWatCont=iwc, soilDepth=soildepth, soilLayers=1)
res <- BioGro(cmi05, day1=100, dayn=270, soilControl = soilP)
...
res <- BioGro(cmi05, centuryControl = centP)
names(res)
@ 
